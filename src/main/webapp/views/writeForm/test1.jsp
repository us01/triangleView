...
<body>
	...
	<div class="centents">
		<jsp:include page="../main/loginMain/leftContent.jsp" flush="true" />
		<div class="reviewListArea">
			<jsp:include page="./write1.jsp" flush="true">
		</div>
		<jsp:include page="../main/loginMain/rightContent.jsp" flush="true">
